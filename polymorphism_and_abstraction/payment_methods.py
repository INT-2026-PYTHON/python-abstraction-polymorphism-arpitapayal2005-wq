...
class CreditCard:
    ...
    def pay(self,amount):        print("[CreditCard]",self.name,"paid",amount,"via card",self.card_number)
...
methods=[CreditCard("Alice","4111-1111-1111-1111"),UPI("bob@upi"),Cash("Carol")]
